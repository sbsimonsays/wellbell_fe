...
function Rewards() {
  ...
  useEffect(() => {
    axios.get(`${API}/bells`).then((res) => setRewards);
  });
  ...
  return (
    <div className="sidebar">
      ...
      <div className="reward-carosel">
        ...
        <img src="../rewards1.png" alt="planet fitness">
          Planet Fitness
        </img>
        <img src="../rewards2.png" alt="fresh direct">
          Fresh Direct
        </img>
        <img src="../rewards3.jpeg" alt="spa castle">
          Spa Castle
        </img>
        <img src="../rewards4.png" alt="planet fitness">
          Nike
        </img>
        <img src="../rewards5.png" alt="whole foods">
          Whole Foods
        </img>
      </div>
    </div>
