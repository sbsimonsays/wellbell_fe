          ...
          <form className="signup-form">
            {formPage ? (
              ...
              <>
                ...
                <input onChange= {handleTextChange} id="username" value={newUser.username} placeholder="username" type="text" required />
                <span className="signup-info">First name</span>
                <input onChange= {handleTextChange} id="firstname" value={newUser.firstname} placeholder="First name" type="text" required/>
                <span className="signup-info">Last name</span>
                <input onChange= {handleTextChange} id="lastname" value={newUser.lastname} placeholder="Last name" type="text" required />
                <span className="signup-info">Photo URL</span>
                <input onChange= {handleTextChange} id="photourl" value={newUser.photourl} placeholder="Add Image" type="text" />
                ...
                <div className="signup-checkboxes">
                  <div>
                  <input type="checkbox" value={ newUser.physicalwellness === check ? true : false } onChange={(e) => setCheck(e.target.checked) } name="physical"/>
                  <label htmlFor="physical">Physical Wellness</label>
                  </div>
                  <div>
                  <input type="checkbox" value={ newUser.nutritionalwellness === check ? true : false } onChange={(e) => setCheck(e.target.checked) } name="nutritional"/>
                  <label htmlFor="nutritional">Nutritional Wellness</label>
                  </div>
                </div>
                <div className="signup-checkboxes-two">
                  <div>
                  <input type="checkbox" value={ newUser.mentalwellness === check ? true : false } onChange={(e) => setCheck(e.target.checked) } name="mental"/>
